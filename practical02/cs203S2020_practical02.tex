...
the documentation for the functions in the program, please add at least four
more tests to establish a confidence in the correctness of the cookbook-style
program. If you have already installed Pipenv and the project's development
dependencies, you can run the tests by typing \command{pipenv run pytest}. How
does this testing strategy compare to the one in the \mbox{last practical?}
