...
\item {\bf Store your files in GitHub}. As in previous laboratory assignments,
  you will be responsible for storing all of your files (e.g., Python source
  code and Markdown-based writing) in a Git repository using GitHub Classroom.
  ...
  by using the provided checking tools on your local computer and by checking
