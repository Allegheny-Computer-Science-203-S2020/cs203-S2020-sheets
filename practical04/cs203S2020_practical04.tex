...
will also start to look for and, if possible, fix ``red flags'' in your system's
design (e.g., ``repetition'' and ``vague name''). You will continue to document
deficiencies of the ``cookbook program style'' and to automated its debugging
